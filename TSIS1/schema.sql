...
--  Run this file once to set up (or upgrade) the database.
-- ============================================================
...
-- Add new columns to an existing contacts table if upgrading
-- from Practice 7/8 (safe to run even if columns already exist).
DO $$
BEGIN
    IF NOT EXISTS (
